...
RegisterCommand('inventory', function()
    ...
    if not isCrafting and not inInventory then
        if not PlayerData.metadata["isdead"] and not PlayerData.metadata["inlaststand"] and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() then
            ...
            local data = {
                weightModifiers = {
                    [0] = { base = 125, max = 150000, slots = 20 },  -- Compacts
                    [1] = { base = 250, max = 300000, slots = 30 }, -- Sedans
                    [2] = { base = 200, max = 500000, slots = 25 }, -- SUVs
                    [3] = { base = 75, max = 250000, slots = 20 }, -- Coupes
                    [4] = { base = 75, max = 250000, slots = 20 }, -- Muscle
                    [5] = { base = 75, max = 200000, slots = 15 }, -- Sports Classics
                    [6] = { base = 75, max = 200000, slots = 15 }, -- Sports
                    [7] = { base = 50, max = 200000, slots = 15 }, -- Super
                    [8] = { base = 0, max = 0, slots = 10 }, -- Motorcycles
                    [9] = { base = 200, max = 600000, slots = 25 }, -- Off-road
                    [10] = { base = 300, max = 1000000, slots = 35 }, -- Industrial
                    [11] = { base = 250, max = 1000000, slots = 30 }, -- Utility
                    [12] = { base = 500, max = 800000, slots = 40 }, -- Van
                    [13] = { base = 0, max = 0, slots = 0 }, -- Cycles
                    [14] = { base = 100, max = 300000, slots = 20 }, -- Boats
                    [15] = { base = 100, max = 400000, slots = 20 }, -- Helicopters
                    [16] = { base = 100, max = 4000000, slots = 20 }, -- Planes
                    [17] = { base = 100, max = 1200000, slots = 20 }, -- Service
                    [18] = { base = 200, max = 500000, slots = 25 }, -- Emergency
                    [19] = { base = 200, max = 500000, slots = 25 }, -- Military
                    [20] = { base = 250, max = 1000000, slots = 30 }, -- Commercial
                    [21] = { base = 200, max = 500000, slots = 25 } -- Trains
                },
                weightOverrides = {
                    ['guardian'] = 750000
                }
            ...
            local function checkWeight(curVeh)
                local maxweight = 0
                local vehicleClass = GetVehicleClass(curVeh)
                local vehModel = GetEntityModel(curVeh)
                for k,v in pairs(data.weightOverrides) do
                ...
                local classBaseWeight = data.weightModifiers[vehicleClass].base
                if classBaseWeight == 0 then
                    maxweight = 0
                    return maxweight
                end
                local classMaxWeight = data.weightModifiers[vehicleClass].max
                ...
                return vehWeightCalc, data.weightModifiers[vehicleClass].slots
            end
            
            if CurrentVehicle ~= nil then
                local vehClass = GetVehicleClass(curVeh)
                local maxweight, slots = checkWeight(curVeh)
                local other =  { maxweight = maxweight, slots = slots }
            
                if vehClass == 8 or vehClass == 13 then
                    QBCore.Functions.Notify('Dieses Fahrzeug hat keinen Kofferraum', 'error', 5000)
                else
            ...
            elseif CurrentGlovebox then
                ...
                if vehClass == 13 then
                    QBCore.Functions.Notify('Dieses Fahrzeug hat kein Handschuhfach', 'error', 5000)
                else
